...
struct ContextHook {
	...
	0x48, 0x87, 0x04, 0x24,                         // xchg   [old_return],rax
	0x49, 0x89, 0x04, 0x24,                         // mov    [reg64_rax],rax
	0xFF, 0x25, 0x7A, 0xFF, 0xFF, 0xFF,             // jmp    [fnNew]
	0x4C, 0x89, 0xE0,                               // mov    rax,r12 <- new_return
	...
	0xFF, 0x30,                                     // push   [reg64_rax]
	0x4C, 0x8B, 0x15, 0x32, 0xFF, 0xFF, 0xFF,       // mov    r10,[pool]
	};
	HookReturnContext asmReturn{};
	uint8_t asmRaw3[6] = {
	0xFF, 0x25, 0x2F, 0xFF, 0xFF, 0xFF,             // jmp    [fnHooked]
	};
};
...
struct ContextHookV {
	...
	0x48, 0x87, 0x04, 0x24,                         // xchg   [old_return],rax
	0x49, 0x89, 0x04, 0x24,                         // mov    [reg64_rax],rax
	0xFF, 0x25, 0x02, 0xFF, 0xFF, 0xFF,             // jmp    [fnNew]
	0x4C, 0x89, 0xE0,                               // mov    rax,r12 <- new_return
	0x48, 0x8B, 0x58, 0x08,                         // mov    rbx,[reg64_rbx]
	0x48, 0x8B, 0x48, 0x10,                         // mov    rcx,[reg64_rcx]
	0x48, 0x8B, 0x50, 0x18,                         // mov    rdx,[reg64_rdx]
	...
	0xFF, 0x30,                                     // push   [reg64_rax]
	0x4C, 0x8B, 0x15, 0x42, 0xFE, 0xFF, 0xFF,       // mov    r10,[pool]
	};
	HookReturnContext asmReturn{};
	uint8_t asmRaw3[6] = {
	0xFF, 0x25, 0x3F, 0xFE, 0xFF, 0xFF,             // jmp    [fnHooked]
	};
};
